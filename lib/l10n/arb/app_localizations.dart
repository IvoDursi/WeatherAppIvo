...
abstract class AppLocalizations {
  ...
  /// Weather description for clear sky
  ///
  /// In en, this message translates to:
  /// **'Clear sky'**
  String get clearSky;

  /// Weather description for few clouds
  ///
  /// In en, this message translates to:
  /// **'Few clouds'**
  String get fewClouds;

  /// Weather description for scattered clouds
  ///
  /// In en, this message translates to:
  /// **'Scattered clouds'**
  String get scatteredClouds;

  /// Weather description for broken clouds
  ///
  /// In en, this message translates to:
  /// **'Broken clouds'**
  String get brokenClouds;

  /// Weather description for shower rain
  ///
  /// In en, this message translates to:
  /// **'Shower rain'**
  String get showerRain;

  /// Weather description for rain
  ///
  /// In en, this message translates to:
  /// **'Rain'**
  String get rain;

  /// Weather description for thunderstorm
  ///
  /// In en, this message translates to:
  /// **'Thunderstorm'**
  String get thunderstorm;

  /// Weather description for snow
  ///
  /// In en, this message translates to:
  /// **'Snow'**
  String get snow;

  /// Weather description for mist
  ///
  /// In en, this message translates to:
  /// **'Mist'**
  String get mist;
